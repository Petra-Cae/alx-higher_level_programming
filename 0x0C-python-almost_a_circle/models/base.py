#!/usr/bin/python3
"""module containing class Base - tests located in test/test_base.py"""
...
class Base:
    ...
    def load_from_file(cls):
        """retrieves string from file and from jsonification"""
        from os import path
